...
<div class="card">
    <div class="card-body">
        <form id="jobCreateForm" method="POST" action="{{ route('job-openings.store') }}">
            @csrf
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="sort_summary" name="sort_summary" rows="3" required>{{ old('sort_summary') }}</textarea>
