...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('assets/admin/assets/images/apon_favicon.png') }}">
...
<body>
                    ...
                    <li class="dropdown me-md-2">
                        <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#"
                            ...
                            <span class="d-lg-flex flex-column gap-1 d-none">
                                ...
                                <h6 class="my-0 fw-normal">{{ Auth::user()->roles[0]->name ?? 'Student' }}
                                </h6>
                            </span>
                        </a>
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <div class="leftbar-user p-3 text-white">
                    <a href="{{ url('/panel/dashboard') }}" class="d-flex align-items-center text-reset">
                        ...
                        <div class="flex-grow-1 ms-2">
                            ...
                            <span class="fs-13">{{ Auth::user()->roles[0]->name ?? 'Admin' }}</span>
                        </div>
                        {{-- <div class="ms-auto">
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        <a href="{{ url('/panel/studentD') }}" class="side-nav-link">
                            <i class="ri-dashboard-line"></i>
                            <span> Dashboard </span>
                        </a>
                    </li>
                    <li class="side-nav-item">
                        <a href="{{ route('users.change-password') }}" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="expensesmenu">
                            <ul class="side-nav-second-level">
                                ...
                                @endcan
                                @can('expense_view')
                                <li><a href="{{ route('expense.report') }}">Expense List</a></li>
                                @endcan
                                @can('expense_head_add')
                                <li><a href="{{ route('expense_heads.create') }}">Add Expense Head</a></li>
                                @endcan
                                @can('expense_head_view')
                                <li><a href="{{ route('expense_heads.index') }}">All Expense  Head</a></li>
                                @endcan
                    ...
                    <!-- Payments Section -->
                    @canany(['payment_view', 'payment_add', 'payment_edit', 'payment_delete', 'purpose_view', 'purpose_add', 'purpose_edit', 'purpose_delete'])
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="paymentsmenu">
                            <ul class="side-nav-second-level">
                                @canany(['payment_add', 'payment_view'])
                                <li><a href="{{ route('payments.index') }}">Add Earning</a></li>
                                @endcan
                                @can('payment_view')
                                <li><a href="{{ route('payments.report') }}">Earning Report</a></li>
                                @endcan
                    ...
                    @canany(['role_view'])
                    <li class="side-nav-item">
                        <a href="{{ route('roles.index') }}" class="side-nav-link d-flex align-items-center w-100 h-100">
                    ...
                    <!-- Permissions -->
                    <!-- @canany(['permission_view'])
                    <li class="side-nav-item">
                        <a href="{{ route('permissions.index') }}" class="side-nav-link d-flex align-items-center w-100 h-100">
                    ...
                    @canany(['user_view'])
                    <li class="side-nav-item">
                        <a href="{{ route('users.index') }}" class="side-nav-link d-flex align-items-center w-100 h-100">
                    ...
                    @canany(['setting_view'])
                    <li class="side-nav-item">
                        <a href="{{ route('setting.index') }}" class="side-nav-link d-flex align-items-center w-100 h-100">
    ...
    <script
        src="{{ asset('assets/admin/assets/vendor/datatables.net-responsive-bs5/js/responsive.bootstrap5.min.js') }}">
    </script>
    <script
    ...
    <script
        src="{{ asset('assets/admin/assets/vendor/datatables.net-buttons/js/dataTables.buttons.min.js') }}"></script>
    ...
    <script
        src="{{ asset('assets/admin/assets/vendor/datatables.net-keytable/js/dataTables.keyTable.min.js') }}"></script>
