        ...
        <div class="leftside-menu">
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <ul class="side-nav">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['brand_view', 'brand_add', 'brand_edit', 'brand_delete'])): ?>
                    <li class="side-nav-item">
                        <a href="<?php echo e(route('brands.index')); ?>" class="side-nav-link d-flex align-items-center w-100 h-100">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['achievement_view', 'achievement_add', 'achievement_edit', 'achievement_delete'])): ?>
                    <li class="side-nav-item">
                        <a href="<?php echo e(route('achievements.index')); ?>" class="side-nav-link d-flex align-items-center w-100 h-100">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['faq_view', 'faq_add', 'faq_edit', 'faq_delete'])): ?>
                    <li class="side-nav-item">
                        <a href="<?php echo e(route('faqs.index')); ?>" class="side-nav-link d-flex align-items-center w-100 h-100">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['team_view', 'team_add', 'team_edit', 'team_delete'])): ?>
                    <li class="side-nav-item">
                        <a href="<?php echo e(route('teams.index')); ?>" class="side-nav-link d-flex align-items-center w-100 h-100">
...
</html><?php /**PATH C:\laragon\www\appdev\resources\views/layouts/admin_master.blade.php ENDPATH**/ ?>