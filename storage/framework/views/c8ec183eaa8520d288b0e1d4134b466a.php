                ...
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('users.create')); ?>" class="btn btn-primary">
                            <i class="ri-add-circle-line"></i> Add Administration
                        </a>
                    </li>
...
<?php echo $__env->make('layouts.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\appdev\resources\views/admin/users/index.blade.php ENDPATH**/ ?>