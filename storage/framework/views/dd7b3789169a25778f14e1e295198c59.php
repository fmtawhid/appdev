...
<body>
    ...
    <div class="login-container">
        ...
        <div class="login-image">
            <div>
                <img src="<?php echo e(asset('assets/admin/auth.jpg')); ?>" alt="" style="width: 100%; height: auto;">
            </div>
        </div>
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="login" placeholder="Enter email or ID" value="<?php echo e(old('login')); ?>">
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>>
...
</html><?php /**PATH C:\laragon\www\appdev\resources\views/auth/login.blade.php ENDPATH**/ ?>